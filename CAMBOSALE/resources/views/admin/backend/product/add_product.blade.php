            ...
            <div class="col-xl-12 col-lg-12">
                ...
                <div class="card-body p-4">
                    <form id="myForm" action="{{ route('category.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select">
                                        ...
                                        <option> ArmFit </option>
                                        <option> Shower </option>

                                        {{-- @foreach($categories as $computer)
                                        <option value="{{ $computer->id }}"> {{$categories->category_name}} </option>
                                        @endforeach --}}
                                    </select>
                                </div>                               
                            </div>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group mb-3">
                                <label for="example-text-input" class="form-label">Discription Name</label>
                                <input class="form-control" type="text" name="category_name" id="example-text-input">
                            </div>                               
                        </div>
